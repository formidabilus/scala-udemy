...
import exercises.MethodNotations.Person
...
object TuplesAndMaps extends App {
  ...
  val phonebook = Map(("Jim", 555), ("Daniel", 789), "Razvan" -> 666).withDefaultValue(-1)
  ...
  // mapValues
  println(phonebook.mapValues(number => "0233-" + number))
